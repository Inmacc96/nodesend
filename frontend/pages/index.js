      ...
      <div className="lg:flex md:shadow-lg p-5 bg-white rounded-lg py-10">
        ...
        <div className="md:flex-1 mb-3 mx-2 mt-16 lg:mt-0">
          ...
          <p className="text-lg leading-loose">
            ...
            allows you to share files with end-to-end encryption and a file is
            deleted after it is downloaded. So you can keep what you share
            private and make sure your stuff does not stay online forever.
          </p>
          <Link href="/signup">
